...
describe('ContactForm', () => {
  ...
  it('should render all form fields with correct placeholders', () => {
    ...
    expect(getMessageInput()).toHaveAttribute(
      'placeholder',
      'How can we help you?',
    );
  });
  ...
  it('should render the query type dropdown with all options', () => {
    ...
    expect(
      screen.getByRole('option', { name: 'Volunteering' }),
    ).toBeInTheDocument();
  });
...
describe('ContactForm validation', () => {
  ...
  it('should not show validation errors when form is valid', async () => {
    ...
    await waitFor(() => {
      ...
      expect(
        screen.queryByText('Please enter a message'),
      ).not.toBeInTheDocument();
    });
  });
  ...
  it('should show error when name exceeds 100 characters', async () => {
    ...
    setFieldValue(getNameInput(), 'a'.repeat(101));
    fireEvent.click(getSubmitButton());
  ...
  it('should not show error when name is exactly 100 characters', async () => {
    ...
    setFieldValue(getNameInput(), 'a'.repeat(100));
    setFieldValue(getEmailInput(), 'jane@example.com');
    setFieldValue(getMessageInput(), 'Hello');
    fireEvent.click(getSubmitButton());
  ...
  it('should show error when message exceeds 2000 characters', async () => {
    ...
    setFieldValue(getNameInput(), 'Jane Smith');
    setFieldValue(getEmailInput(), 'jane@example.com');
    setFieldValue(getMessageInput(), 'a'.repeat(2001));
    fireEvent.click(getSubmitButton());
  ...
  it('should not show error when message is exactly 2000 characters', async () => {
    ...
    setFieldValue(getNameInput(), 'Jane Smith');
    setFieldValue(getEmailInput(), 'jane@example.com');
    setFieldValue(getMessageInput(), 'a'.repeat(2000));
    fireEvent.click(getSubmitButton());
