...
export const LocationCard = ({
  ...
  const parsedAddressLines = t(addressLines, {
    returnObjects: true,
  }) as string[];
    ...
    <Card className='location-card' data-testid='location-card'>
      ...
      <CardContent className='location-card__content'>
        <div className='location-card__date'>
          ...
          <div className='location-card-body' data-testid='location-card-date'>
            {t(sessionTimes)}
          </div>
        </div>
        ...
        <div className='location-card__location'>
          ...
          <div
            ...
            data-testid='location-card-address'
          >
            {parsedAddressLines.map((line) => (
          ...
          >
            ...
            <div className='location-card-link__text'>
              {t('join.common.maps')}
            </div>
          </a>
        </div>
        ...
        <div
          className='location-card__spaces'
          data-testid='location-card-spaces'
        >
          <div className='location-card-title'>{t('join.common.spaces')}</div>
          <div className='location-card-body'>
            {spacesAvailable ? t('common.yes') : t('common.no')}
          </div>
        </div>
      </CardContent>
    </Card>
