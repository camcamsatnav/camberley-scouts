...
export const HutRenovationPage = () => {
  ...
  const improvementLines = t('aboutUs.hutRenovation.card3.description', {
    returnObjects: true,
  }) as string[];
  ...
  return (
    <div className='hut-renovation-page' data-testid='hut-renovation-page'>
      ...
      <div
        className='hut-renovation-page__image'
        data-testid='hut-renovation-page-image'
      >
        <img src={RENOVATED_HUT_IMAGE_PATH} alt='Renovated scout hut' />
      </div>
      <div className='hut-renovation-page__description'>
        {t('aboutUs.hutRenovation.description')}
      </div>
