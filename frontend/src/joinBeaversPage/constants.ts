...
export const JOIN_BEAVERS_LOCATIONS: LocationCardProps[] = [BEAVERS_LOCATION_ONE, BEAVERS_LOCATION_TWO];

export const JOIN_BEAVERS_IMAGES: FileImage[] = [
  { src: '/joinBeaversPage/joinbeavers1.jpg', alt: 'Beavers climbing' },
  { src: '/joinBeaversPage/joinbeavers2.jpg', alt: 'Beavers at an outdoor event' },
  { src: '/joinBeaversPage/joinbeavers3.jpg', alt: 'Beavers at the Surrey Bazzaz' },
];

export const JOIN_BEAVERS_LOGO: FileImage = {
  src: '/homePage/beavers.png', alt: 'Beavers',
};
