...
it('should render JoinIntro correctly', () => {
  ...
  expect(screen.getByTestId('join-logo')).toHaveAttribute('src', JOIN_BEAVERS_LOGO.src);
  expect(screen.getByTestId('join-logo')).toHaveAttribute('alt', JOIN_BEAVERS_LOGO.alt);
